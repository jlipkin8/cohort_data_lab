...
def find_cohort_by_student_name(student_list):
    ...
    # Code goes here
    search_student = raw_input("Who are you looking for? ")
    for student_info in student_list: 
        if search_student in student_info: 
            return student_info[0] + " was in the " + student_info[-1]
...
def find_name_duplicates(filename):
    ...
    for line in cohort_data: 
        ...
        if(cohort == 'Fall 2015'):
            ...
            spring_16.add(l_name)
        elif(cohort == 'Summer 2016'):
            summer_16.add(l_name)
        elif(cohort == 'Winter 2016'):
            winter_16.add(l_name)
...
def find_house_members_by_student_name(student_list):
    ...
    user_student = raw_input("Chose a student: ")
    for student_info in student_list: 
        if user_student in student_info:
            house = student_info[1]
            cohort = student_info[-1]
            print user_student + " was in house " + house + " in the " + cohort

    print "The following students are also in their house:"
    for student_info in student_list: 
        if (student_info[-1] == cohort) and (student_info[1] == house): 
